                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.H5(
                                    "Dados diariamente atualizados", style={"margin-top": "0px"}
                                ),
                            ]
                        )
                    ],
            ...
            [
                html.Div(
                    [
                        ...
                        dcc.Checklist(
                            id="lock_selector",
                            options=[{"label": "Brasil ", "value": "locked"}],
                            className="dcc_control",
                            value=[],
                        ),
                        html.P("Filtre por países: ", className="control_label"),
                        dcc.RadioItems(
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.Div(
                                    [html.H6(id="well_text"), html.P("Total Confirmado")],
                                    id="wells",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id="gasText"), html.P("Total Mortes")],
                                    id="gas",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id="oilText"), html.P("Total Recuperados")],
                                    id="oil",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id="waterText"), html.P("Total países atingidos")],
                                    id="water",
                                    className="mini_container",
                                ),
                            ],
